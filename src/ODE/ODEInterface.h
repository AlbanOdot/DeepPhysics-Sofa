...
/**
 * This class is hugely inspired by https://github.com/jnbrunet/caribou/blob/master/src/SofaCaribou/Ode/NewtonRaphsonSolver.h
 */
    class ODEInterface : public sofa::core::behavior::OdeSolver {
    public:
        SOFA_CLASS(ODEInterface, sofa::core::behavior::OdeSolver);

        template <typename T>
        using Data = sofa::core::objectmodel::Data<T>;

        template <typename T>
        using Link = sofa::core::objectmodel::SingleLink<ODEInterface, T, sofa::core::objectmodel::BaseLink::FLAG_STRONGLINK>;
        ...
        CARIBOU_API
        void solve (const sofa::core::ExecParams* /*params*/, SReal /*dt*/, sofa::core::MultiVecCoordId /*x_id*/, sofa::core::MultiVecDerivId /*v_id*/){};
