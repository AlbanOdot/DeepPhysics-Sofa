...
namespace DeepPhysicsSofa::ode {
    ...
    void ODEInterface::reset() {
        p_has_already_analyzed_the_pattern = false;
    }

    bool ODEInterface::has_valid_linear_solver() const {
        return (
    ...
    auto ODEInterface::pattern_analysis_strategy() const -> ODEInterface::PatternAnalysisStrategy {
        ...
        // Default value
        return ODEInterface::PatternAnalysisStrategy::BEGINNING_OF_THE_TIME_STEP;
    }

    void ODEInterface::set_pattern_analysis_strategy(const ODEInterface::PatternAnalysisStrategy & strategy) {
